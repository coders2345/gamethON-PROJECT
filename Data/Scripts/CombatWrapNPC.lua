...
function DESTRUCTIBLE_MANAGER() return MODULE.Get_Optional("godMode.NPCKit.DestructibleManager") end
function NPC_MANAGER() return MODULE.Get_Optional("godMode.NPCKit.NPCManager") end
